    ...
    <!-- ./wrapper -->
    <!-- jQuery 3 -->
    <script src="<%=pasta%>assets/bower_components/jquery/dist/jquery.min.js"></script>
    <!-- jQuery UI 1.11.4 -->
    <script src="<%=pasta%>assets/bower_components/jquery-ui/jquery-ui.min.js"></script>
    <!-- Resolve conflict in jQuery UI tooltip with Bootstrap tooltip -->
    <script type="text/javascript">
      $.widget.bridge('uibutton', $.ui.button);
    </script>
    <!-- Bootstrap 3.3.7 -->
    <script src="<%=pasta%>assets/bower_components/bootstrap/dist/js/bootstrap.min.js"></script>
    <!-- daterangepicker -->
    <script src="<%=pasta%>assets/bower_components/moment/min/moment.min.js"></script>
    <script src="<%=pasta%>assets/bower_components/bootstrap-daterangepicker/daterangepicker.js"></script>
    <!-- datepicker -->
    <script src="<%=pasta%>assets/bower_components/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js"></script>
    <script src="<%=pasta%>assets/bower_components/bootstrap-datepicker/dist/locales/bootstrap-datepicker.pt-BR.min.js"></script>
    <!-- Autosize -->
    <script src="<%=pasta%>assets/bower_components/autosize/dist/autosize.min.js"></script>
    <!-- Dropzone.js -->
    <script src="<%=pasta%>assets/bower_components/dropzone/dist/min/dropzone.min.js"></script>
    <!-- DataTables -->
    <script src="<%=pasta%>assets/bower_components/datatables.net/js/jquery.dataTables.min.js"></script>
    <script src="<%=pasta%>assets/bower_components/datatables.net-bs/js/dataTables.bootstrap.min.js"></script>
    <!-- Slimscroll -->
    <script src="<%=pasta%>assets/bower_components/jquery-slimscroll/jquery.slimscroll.min.js"></script>
    <!-- FastClick -->
    <script src="<%=pasta%>assets/bower_components/fastclick/lib/fastclick.js"></script>
    <!-- jquery.inputmask -->
    <script src="<%=pasta%>assets/bower_components/inputmask/dist/min/jquery.inputmask.bundle.min.js" charset="utf-8"></script>
    <!-- Select2 -->
    <script src="<%=pasta%>assets/bower_components/select2/dist/js/select2.full.min.js"></script>
    <script src="<%=pasta%>assets/bower_components/select2/dist/js/i18n/pt-BR.js"></script>
    <!-- AdminLTE App -->
    <script src="<%=pasta%>assets/dist/js/adminlte.min.js"></script>
